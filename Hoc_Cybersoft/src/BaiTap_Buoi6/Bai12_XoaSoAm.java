...
public class Bai12_XoaSoAm {
	public static void main(String[] args) {
		...
		// Hàm xóa tất cả các số âm có trong mảng và cập nhật lại số lượng phần tử trong mảng
	...
	private static int xoaSoAm(float[] mangArray, int n) {
		System.out.println("Xóa tất cả các số âm trong mảng số thực: ");
		int i, c;
		for (c = i = 0; i < n; i++) {
			if (mangArray[i] > 0) {
